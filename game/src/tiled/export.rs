...
enum ExportConversionError {
    ...
    ListUnsupported,
    #[display("map fields are not supported")]
    MapUnsupported,
    #[display("field of type {_0} is not supported")]
    UnsupportedValue(&'static str),
    #[display("set fields are not supported")]
    SetUnsupported,
    #[display("a dependency is not supported")]
    DependencyError,
}
